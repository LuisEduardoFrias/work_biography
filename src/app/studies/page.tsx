...
import { YoutuberEntity, StudiesEntity, TitleEntity, BookEntity, OtherResourveEntity } from 'cp/title_page'
...
export default function Studies() {
  ...
  const [data, setData] = useState<StudiesEntity>(null)

  useEffect(() => {
    (async () => {
      const g = await ActionFetchApi("study", 'GET');
      console.log('data---: ', g)
      setData(g)
    })()
  }, [])
...
function SectionTwo({ translate, youtubers, otherResourves }: { translate: (value: string) => string, youtubers: YoutuberEntity[], otherResourves: BookEntity[] }) {
  return (
    <>
