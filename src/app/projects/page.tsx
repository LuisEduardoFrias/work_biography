...
export default function Projects() {
	...
	return (
		<Page>
			<div className="border border-blue-500 -md:col-start-1 -md:col-end-2 md:col-start-1 md:col-end-2 row-start-1 md:row-end-2 -md:row-end-3 h-full relative">
			...
			<div className="border border-red-500 -md:col-start-1 -md:col-end-2 -md:row-start-2 -md:row-end-3 md:col-start-2 -md:col-end-3 -md:row-start-1 -md:row-end-2 h-full  relative">
			</div>
		</Page>
	);
}
